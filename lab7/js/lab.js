...
// pass the name as a parameter to the functions and return the result
  var nameHere = window.prompt("Please enter your name:");
  console.log("nameHere = ", nameHere);

  function sortUserName() {

      //convert userName to an array
      var strArray = nameHere.split('');
  ...
  document.writeln("Here is your new name: " + sortName() + "</br");
  document.writeln("Enjoy your new name:  " + sortUserName() + "</br");
